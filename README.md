<div align="center">
  <h1>🐧 Sistemas Operativos (75.08)</h1>
  <p><strong>Facultad de Ingeniería de la Universidad de Buenos Aires (FIUBA)</strong></p>
  <p>Colección de trabajos prácticos implementados en C.</p>
</div>
